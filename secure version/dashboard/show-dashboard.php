...
if ( verifyUserCookieSession() === false ) : 
...
<?php die(); endif;
    ...
    if ( isset($_POST['create_post']) && isset($_POST['title']) && isset($_POST['content']) && isset($_POST['csrf']) && $_POST['csrf'] == $_COOKIE['csrf_token'] ) {
    ...
    $userPostsQuery = getUserPosts($_COOKIE['user']);

?>

<?php if ( isset($createPostBoolean) && $createPostBoolean === true ) : ?>
...
<div id="dashboard-create-post">

    <form method="POST">

        <h2>Create Post</h2>

        <input type="hidden" name="csrf" value="<?php echo $_COOKIE['csrf_token']; ?>"/>
...
<div id="dashboard-list-of-post-main">

    <h2>Your Posts</h2>

    <?php if ( empty($userPostsQuery) ) : ?>
    ...
    <div id="dahboard-list-of-posts">
        ...
        <?php foreach ($userPostsQuery as $singleRow) : ?>
